...
export class Prevention extends Component {
  render() {
    return (
      <div style={{ marginTop: '100px',marginLeft:'30px',marginRight:'30px',minWidth:'440px'}}>
        <h2 style={{ margin: '20px',textAlign:'center'}}>Prevention of COVID-19</h2>
          <div id='contents'>
              <div>
                <h5 style={{ marginTop: '30px',marginBottom:'10px'}}>The following actions help in preventing the spread of Covid-19:</h5>
                  <ul>
              ...
              <div>  
              <h5 style={{ marginTop: '30px',marginBottom:'10px'}}>Washing hands effectively:</h5>
                <p>Wash your hands often with soap and water for at least 20 seconds, especially after going to the bathroom; before eating; after blowing your nose, coughing, or sneezing; and after handling anything that's come from outside your home.</p>
                  <ul>
              ...
              <div>
                <h5 style={{ marginTop: '30px',marginBottom:'10px'}}>How does Coronavirus spread?</h5>
                  ...
                  <p>Coronavirus can also spread from contact with infected surfaces or objects. For example, a person can get COVID-19 by touching a surface or object that has the virus on it and then touching their own mouth, nose, or possibly their eyes.</p>

                <h5 style={{ marginTop: '30px',marginBottom:'10px'}}>What is social distancing and why is it important?</h5>
